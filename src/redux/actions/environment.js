...
export const ENVIRONMENT_NAVIGATION_CONSTANTS_CHANGE = 'ENVIRONMENT_NAVIGATION_CONSTANTS_CHANGE';
...
export const navigationConstantsChange = (constants) => action(ENVIRONMENT_NAVIGATION_CONSTANTS_CHANGE, {constants});
