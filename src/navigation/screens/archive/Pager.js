...
import { PagerRendererPropType } from 'react-native-tab-view/src/PropTypes';
import type { PagerRendererProps } from 'react-native-tab-view/src/TypeDefinitions';

type Props<T> = PagerRendererProps<T> & {
    swipeDistanceThreshold?: number,
    swipeVelocityThreshold?: number,
    swipeMinDeltaX?: number,
    GestureHandler: any,
};
